...
router.get("/my-propositions/", verifyToken,verifyIsProf , propositionController.getMyPropositions )
router.post("/create/:id", verifyToken, verifyIsStudent, propositionController.createProposition);
